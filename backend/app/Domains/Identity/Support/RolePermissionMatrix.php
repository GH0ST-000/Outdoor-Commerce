    ...
    public static function matrix(): array
    {
        return [
            ...
            Role::CatalogManager->value => [
                ...
                Permission::RecommendationsSimulate,
                Permission::RecommendationsProfilesView,
                Permission::RecommendationsAssignmentsView,
                Permission::RecommendationsAssignmentsManage,
                Permission::RecommendationsMerchandisingView,
                Permission::RecommendationsCoverageView,
            ...
            Role::LegalEditor->value => [
                ...
                Permission::LegalSeasonsView,
                Permission::LegalSeasonsCreate,
                Permission::LegalSeasonsUpdate,
                Permission::LegalSeasonsReview,
                Permission::LegalSeasonsPublish,
                Permission::LegalSeasonsGenerate,
                Permission::LegalSeasonOverridesView,
                Permission::LegalSeasonOverridesCreate,
                Permission::LegalSeasonOverridesReview,
                Permission::LegalSeasonOverridesPublish,
                Permission::LegalCalendarPreview,
                Permission::LegalCalendarCoverage,
                Permission::LegalCalendarGenerationRunsView,
                Permission::SpatialSourcesView,
                Permission::SpatialSourcesManage,
                Permission::SpatialSourcesVerify,
                Permission::SpatialDatasetsView,
                Permission::SpatialDatasetsManage,
                Permission::SpatialVersionsUpload,
                Permission::SpatialVersionsValidate,
                Permission::SpatialVersionsImport,
                Permission::SpatialVersionsReview,
                Permission::SpatialZonesView,
                Permission::SpatialZonesManage,
                Permission::SpatialGeometryReview,
                Permission::SpatialRulesAssign,
                Permission::SpatialConflictsView,
                Permission::SpatialPreviewEvaluate,
                Permission::SpatialAuditView,
                Permission::ContentView,
                Permission::SpeciesView,
