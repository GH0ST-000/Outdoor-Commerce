...
use App\Http\Requests\Api\V1\Admin\Inventory\AdjustInventoryRequest;
...
final class AdminInventoryAdjustmentController
{
    use AuthorizesRequests;

    public function store(AdjustInventoryRequest $request, AdjustInventoryAction $action): JsonResponse
    {
