...
export function LegalDemoBanner() {
  ...
  return (
    <p
      role="note"
      className="rounded-xl border border-[color-mix(in_oklab,var(--amber)_35%,transparent)] bg-[color-mix(in_oklab,var(--amber)_12%,transparent)] px-4 py-3 text-sm text-foreground"
    >
