...
export const storefrontCopy = {
  en: {
    ...
    calendar: {
      title: "Hunting and fishing seasons",
      lead: "What can I hunt or fish during this period? Results use published official sources. Missing data is unknown, not permission.",
      ...
      region: "Region",
      species: "Species",
      searchAction: "Show seasons",
      modeAny: "Any day in the period",
      modeEntire: "Entire period",
      modeTimeline: "Day-by-day timeline",
      modeHelp: "The selected mode is always shown with the results.",
      tabPeriod: "Period",
      tabPlace: "Place and species",
      tabMode: "Mode",
      thisWeek: "This week",
      next7: "Next 7 days",
      ...
      regulationsTitle: "Georgian hunting and fishing checks",
      regulationsLead:
        "Essential checks before a trip. Confirm every item against official sources — this list is not the law.",
      checklist: [
        "Valid hunting or fishing license for the selected period",
        "Weapon or gear permit matching the listed equipment",
        "Species window verified for the region",
        "Bag or catch limit recorded before the trip",
      ...
      disclaimer:
        "This is informational and is not legal advice. Absence of a prohibition is not permission. Official sources remain authoritative.",
      emptyTitle: "No verified season records",
      emptyLead:
        "No published season matched this search. That does not mean hunting or fishing is closed — it means we do not have verified data yet.",
      errorTitle: "Season data could not be loaded",
      loading: "Loading verified seasons…",
      viewDetails: "View species details",
      lastVerified: "Last verified",
      officialSource: "Official source",
      openWindow: "Open window in this period",
      conditionalWindow: "Conditional window in this period",
      dailyLimit: "Daily limit",
      onlyIn: "Only in",
      excluding: "Excluding",
      nextOpen: "Next opening",
      nextClose: "Next closing",
      conflictNote:
        "Two official texts name different opening days. This card is not a permission.",
      groups: {
        waterfowl: "Waterfowl",
        quail: "Quail",
        snipe: "Snipe",
      ...
      periodSources: {
        order_95: "Order No. 95",
        mepa_2026: "Ministry notice, 2026",
      },
      resultsCount: "species with verified season records",
      timelineLabel: "Availability timeline",
      regionHint:
        "Region is optional. National rules apply when a region is not selected.",
      seasonsHeading: "Season and availability",
      noRegion: "All regions / national",
    },
    map: {
  ...
  ka: {
    ...
    calendar: {
      title: "სანადირო და სათევზაო სეზონები",
      lead: "რაზე შეიძლება ნადირობა ან თევზაობა ამ პერიოდში? შედეგები გამოქვეყნებულ ოფიციალურ წყაროებს ეყრდნობა. გამოტოვებული მონაცემი უცნობია და არა ნებართვა.",
      search: "სახეობის ძიება",
      open: "ღია",
      closed: "დახურული",
      conditional: "პირობითი",
      unknown: "უცნობი",
      partiallyOpen: "ნაწილობრივ ღია",
      conflict: "წესების კონფლიქტი",
      hunting: "ნადირობა",
      fishing: "თევზაობა",
      ...
      region: "რეგიონი",
      species: "სახეობა",
      searchAction: "სეზონების ჩვენება",
      modeAny: "ნებისმიერი დღე პერიოდში",
      modeEntire: "მთელი პერიოდი",
      modeTimeline: "დღეების ქრონოლოგია",
      modeHelp: "არჩეული რეჟიმი ყოველთვის ჩანს შედეგებთან ერთად.",
      tabPeriod: "პერიოდი",
      tabPlace: "ადგილი და სახეობა",
      tabMode: "რეჟიმი",
      thisWeek: "ეს კვირა",
      next7: "შემდეგი 7 დღე",
      thisMonth: "ეს თვე",
      nextMonth: "შემდეგი თვე",
      custom: "არჩეული პერიოდი",
      eyebrow: "სეზონების ძიება",
      regulationsTitle: "ქართული სანადირო და სათევზაო შემოწმებები",
      regulationsLead:
        "აუცილებელი შემოწმებები გასვლამდე. თითოეული პუნქტი ოფიციალურ წყაროს გადაამოწმეთ — ეს სია კანონი არ არის.",
      checklist: [
        "მოქმედი სანადირო ან სათევზაო ლიცენზია არჩეული პერიოდისთვის",
        "იარაღის ან აღჭურვილობის ნებართვა, რომელიც ემთხვევა მითითებულს",
      ...
      disclaimer:
        "ეს არის საინფორმაციო მასალა და არ არის იურიდიული კონსულტაცია. აკრძალვის არარსებობა ნებართვას არ ნიშნავს. ოფიციალური წყარო რჩება უპირატესი.",
      emptyTitle: "დადასტურებული სეზონი არ მოიძებნა",
      emptyLead:
        "ამ ძიებას გამოქვეყნებული სეზონი არ დაემთხვა. ეს არ ნიშნავს, რომ ნადირობა ან თევზაობა დახურულია — ნიშნავს, რომ დადასტურებული მონაცემი ჯერ არ არის.",
      errorTitle: "სეზონის მონაცემი ვერ ჩაიტვირთა",
      loading: "დადასტურებული სეზონები იტვირთება…",
      viewDetails: "სახეობის დეტალები",
      lastVerified: "ბოლო გადამოწმება",
      officialSource: "ოფიციალური წყარო",
      openWindow: "ღია ფანჯარა ამ პერიოდში",
      conditionalWindow: "პირობითი ფანჯარა ამ პერიოდში",
      dailyLimit: "დღიური ლიმიტი",
      onlyIn: "მხოლოდ",
      excluding: "გარდა",
      nextOpen: "შემდეგი გახსნა",
      nextClose: "შემდეგი დახურვა",
      conflictNote:
        "ორი ოფიციალური ტექსტი სხვადასხვა გახსნის დღეს ასახელებს. ეს ბარათი ნებართვა არ არის.",
      groups: {
        waterfowl: "წყალმცურავი ფრინველები",
        quail: "მწყერი",
        snipe: "ჩიბუხა",
        woodcock: "ტყის ქათამი",
        pigeons: "მტრედისნაირები",
        other: "სხვა",
      },
      periodSources: {
        order_95: "ბრძანება №95",
        mepa_2026: "სამინისტროს ცნობა, 2026",
      },
      resultsCount: "სახეობა დადასტურებული სეზონით",
      timelineLabel: "ხელმისაწვდომობის ქრონოლოგია",
      regionHint:
        "რეგიონი სავალდებულო არ არის. რეგიონის გარეშე მოქმედებს ეროვნული წესები.",
      seasonsHeading: "სეზონი და ხელმისაწვდომობა",
      noRegion: "ყველა რეგიონი / ეროვნული",
    },
    map: {
...
export const primaryNav = [
  ...
  { id: "calendar", href: "/seasons", labelKey: "calendar" as const },
